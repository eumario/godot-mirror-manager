...
public class ScraperService : IScraperService
{
	...
	internal List<EngineUrl>? GetUrls(MirrorSite site, string version, string href, List<string> tags)
	{
		...
		current.Linux32 = zips.Where(href => href.EndsWith("x11_32.zip") || href.EndsWith("linux_32.zip") || href.EndsWith("x11.32.zip") || href.EndsWith("linux.32.zip")).FirstOrDefault("");
		current.Linux64 = zips.Where(href => href.EndsWith("x11_64.zip") || href.EndsWith("linux_64.zip") || href.EndsWith("x11.64.zip") || href.EndsWith("linux.64.zip")).FirstOrDefault("");
